...
import com.threathunter.daemon.singlepixel.ScreenManager;
import com.threathunter.daemon.singlepixel.ScreenReceiverUtil;
...
public class WatchDogService extends Service {
    ...
    protected static final int HASH_CODE = 0x999;
...
//            DaemonEnv.startServiceSafely(WatchDogService.this, PlayMusicService.class,IsShouldStopSelf);// 手机耗电
        }
    }
...
//        System.exit(0);
    ...
    public static class WatchDogNotificationService extends Service {
        ...
        public int onStartCommand(Intent intent, int flags, int startId) {
            ...
            startForeground(WatchDogService.HASH_CODE, builder.build());
            stopSelf();
            return START_STICKY;
        }
